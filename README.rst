...
* `Sentiment HebrewDataset <https://github.com/shlomisumit/HebrewDatasets>`_ {`MIT license <https://github.com/shlomisumit/HebrewDatasets/blob/main/LICENSE.md>`_} - Created by SUMIT-AI company. The dataset contains 75,152 tagged sentences from 3 categories: economy, news(mostly politics) and sport. All the sentences were annotated by crowd members (2-5 annotators) to sentiment: positive, negative or neutral.
