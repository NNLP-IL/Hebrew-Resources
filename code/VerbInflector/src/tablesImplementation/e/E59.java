...
public class E59 extends E1{
	...
	public HebrewLetter[] vocalize(HebrewLetter[] letterArr){
		...
		letterArr[5].setVocalization_TSERE();
		if (letterArr[6].isKafSofit()){
			letterArr[6].setVocalization_SHVA();
		}
		return letterArr;
	}
	...
	public HebrewVerb present1MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_MemHirik(wNew, 6);
		wNew.finalizeWord();
	...
	public HebrewVerb future1S(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_AlefSegol(wNew, 6);
		wNew.finalizeWord();
	...
	public HebrewVerb future2MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_TavDageshHirik(wNew, 6);
		wNew.finalizeWord();
	...
	public HebrewVerb future3MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_YodHirik(wNew, 6);
		wNew.finalizeWord();
	...
	public HebrewVerb future1P(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_NunHirik(wNew, 6);
		wNew.finalizeWord();
