...
public class A38 extends A1{
	...
	public HebrewVerb past2MP(HebrewVerb w){
		...
		this.macro_VavHolamM(wNew, 2);
		wNew.removeLetter();
		this.macro_Shva_TavDageshSegol_MemS(wNew, 1);
		wNew.finalizeWord();
	...
	public HebrewVerb past2FP(HebrewVerb w){
		...
		this.macro_VavHolamM(wNew, 2);
		wNew.removeLetter();
		this.macro_Shva_TavDageshSegol_NunS(wNew, 1);
		wNew.finalizeWord();
	...
	public HebrewVerb future1SComp(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.removeDagesh();
		this.macro_BEFORE_AlefTsere(wNew, 3);
		wNew.finalizeWord();
	...
	public HebrewVerb future2MSComp(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.removeDagesh();
		this.macro_BEFORE_TavDageshTsere(wNew, 3);
		wNew.finalizeWord();
	...
	public HebrewVerb future3MSComp(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.removeDagesh();
		this.macro_BEFORE_YodTsere(wNew, 3);
		wNew.finalizeWord();
	...
	public HebrewVerb future1PComp(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.removeDagesh();
		this.macro_BEFORE_NunTsere(wNew, 3);
		wNew.finalizeWord();
	...
	public HebrewVerb infinitiveComp(HebrewVerb w){
		 HebrewVerb wNew = new HebrewVerb(w);
		 wNew.removeDagesh();
		 this.macro_BEFORE_LamedTsere(wNew, 3);
		 wNew.finalizeWord();
