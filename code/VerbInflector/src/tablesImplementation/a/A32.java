...
public class A32 extends A29{
	...
	public HebrewLetter[] vocalize(HebrewLetter[] letterArr){
		...
		letterArr[1].setVocalization_HOLAM_H();
	...
	public HebrewVerb future1SComp(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.removeLetter();
		this.macro_BEFORE_Alef_VavShuruk(wNew, 2);
	...
	public HebrewVerb future2MSComp(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.removeLetter();
		this.macro_BEFORE_TavDagesh_VavShuruk(wNew, 2);
		wNew.setVocalization_PATAH();
		wNew.movePointer(1);
		wNew.finalizeWord();
	...
	public HebrewVerb future3MSComp(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.removeLetter();
		this.macro_BEFORE_Yod_VavShuruk(wNew, 2);
		wNew.setVocalization_PATAH();
		wNew.movePointer(1);
		wNew.finalizeWord();
	...
	public HebrewVerb future1PComp(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.removeLetter();
		this.macro_BEFORE_Nun_VavShuruk(wNew, 2);
		wNew.setVocalization_PATAH();
		wNew.movePointer(1);
		wNew.finalizeWord();
