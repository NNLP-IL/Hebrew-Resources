...
public class C27 extends C26{
	...
	public ArrayList<HebrewVerb> makePastInflictions(HebrewVerb w){
		...
		pastInflictions.add(this.past3MSC(w));
		pastInflictions.add(this.past3MSD(w));
	...
	public HebrewVerb past3MSC(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.movePointer(1);
		wNew.setVocalization_SHVA();
		wNew.movePointer(2);
	...
	public HebrewVerb past3MSD(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.movePointer(1);
		wNew.setVocalization_SHVA();
		wNew.movePointer(1);
	...
	public HebrewVerb future1SC(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_AlefHPatah(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb future1SD(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_AlefHPatah(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb future2MSC(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_TavDageshShva(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb future2MSD(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_TavDageshShva(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb future2FSB(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_TavDageshShva(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb future3MSC(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_YodShva(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb future3MSD(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_YodShva(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb future3FSC(HebrewVerb w){
		HebrewVerb wNew = this.future2MSC(w);
		wNew.setMorphology(HebrewVerb.Time.FUTURE, HebrewVerb.Gender.F, HebrewVerb.Person.THIRD, HebrewVerb.Number.SINGULAR, HebrewVerb.Spelling.COMPLETE);
		return wNew;
	}
	
	public HebrewVerb future3FSD(HebrewVerb w){
		HebrewVerb wNew = this.future2MSD(w);
		wNew.setMorphology(HebrewVerb.Time.FUTURE, HebrewVerb.Gender.F, HebrewVerb.Person.THIRD, HebrewVerb.Number.SINGULAR, HebrewVerb.Spelling.COMPLETE);
		return wNew;
	}
	...
	public HebrewVerb future1PC(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_NunShva(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb future1PD(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_NunShva(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb future2MPB(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_TavDageshShva(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb future2FPB(HebrewVerb w){
		HebrewVerb wNew = this.future2MPB(w);
		wNew.setMorphology(HebrewVerb.Time.FUTURE, HebrewVerb.Gender.F, HebrewVerb.Person.SECOND, HebrewVerb.Number.PLURAL, HebrewVerb.Spelling.COMPLETE);
		return wNew;
	}
	...
	public HebrewVerb future2FPD(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_TavDageshShva(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb future3MPB(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_YodShva(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb future3FPB(HebrewVerb w){
		HebrewVerb wNew = this.future3MPB(w);
		wNew.setMorphology(HebrewVerb.Time.FUTURE, HebrewVerb.Gender.F, HebrewVerb.Person.THIRD, HebrewVerb.Number.PLURAL, HebrewVerb.Spelling.COMPLETE);
		return wNew;
	}
	...
	public HebrewVerb future3FPD(HebrewVerb w){
		HebrewVerb wNew = this.future2FPD(w);
		wNew.setMorphology(HebrewVerb.Time.FUTURE, HebrewVerb.Gender.F, HebrewVerb.Person.THIRD, HebrewVerb.Number.PLURAL, HebrewVerb.Spelling.COMPLETE);
		return wNew;
	}
	...
	public ArrayList<HebrewVerb> makeImperativeInflictions(HebrewVerb w){
		...
		imperativeInflictions.add(this.imperative2MSC(w));
		imperativeInflictions.add(this.imperative2MSD(w));
		...
		imperativeInflictions.add(this.imperative2FPD(w));
	...
	public HebrewVerb imperative2MSC(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.setVocalization_PATAH();
		wNew.movePointer(1);
		wNew.setVocalization_SHVA();
	...
	public HebrewVerb imperative2MSD(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.setVocalization_PATAH();
		wNew.movePointer(1);
		wNew.setVocalization_SHVA();
	...
	public HebrewVerb imperative2FPD(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		wNew.setVocalization_PATAH();
		wNew.movePointer(1);
		wNew.setVocalization_SHVA();
	...
	public ArrayList<HebrewVerb> makeInfinitiveInflictions(HebrewVerb w){
		 ...
		 infinitiveInflictions.add(this.infinitiveCompC(w));
		 infinitiveInflictions.add(this.infinitiveCompD(w));
	...
	public HebrewVerb infinitiveCompC(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_LamedShva(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
	...
	public HebrewVerb infinitiveCompD(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_LamedShva(wNew, 1);
		wNew.removeDagesh();
		wNew.setVocalization_PATAH();
