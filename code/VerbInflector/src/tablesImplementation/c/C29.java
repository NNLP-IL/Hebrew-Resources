...
public class C29 extends C20{
	...
	public HebrewVerb present1MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_MemSegol(wNew, 1);
		wNew.removeDagesh();
		wNew.movePointer(1);
		wNew.setVocalization_PATAH();
		wNew.movePointer(3);
	...
	public HebrewVerb future1S(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_AlefPatah(wNew, 1);
		wNew.removeDagesh();
		wNew.movePointer(1);
		wNew.setVocalization_PATAH();
		wNew.movePointer(3);
	...
	public HebrewVerb infinitiveComp(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_LamedSegol(wNew, 1);
		wNew.removeDagesh();
		wNew.movePointer(1);
		wNew.setVocalization_PATAH();
		wNew.movePointer(3);
