...
public class F29 extends F26{
	...
	public HebrewVerb present1MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_MemPatah(wNew, 3);
		wNew.finalizeWord();
	...
	public HebrewVerb future1S(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_AlefPatah(wNew, 3);
		wNew.finalizeWord();
	...
	public HebrewVerb future3MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_YodPatah(wNew, 3);
		wNew.finalizeWord();
	...
	public HebrewVerb future1P(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_NunPatah(wNew, 3);
		wNew.finalizeWord();
