...
public class F26 extends F1{
	...
	public HebrewVerb future1S(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_AlefPatah(wNew, 4);
		wNew.finalizeWord();
	...
	public HebrewVerb future2MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_TavDageshPatah(wNew, 4);
		wNew.finalizeWord();
	...
	public HebrewVerb future3MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_YodPatah(wNew, 4);
		wNew.finalizeWord();
	...
	public HebrewVerb future1P(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_NunPatah(wNew, 4);
		wNew.finalizeWord();
	...
	public HebrewVerb future2FPB(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_TavDageshPatah(wNew, 2);
