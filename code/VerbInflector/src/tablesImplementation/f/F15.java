...
public class F15 extends F1{
	...
	public HebrewVerb present1MS(HebrewVerb w){
		...
		this.replaceLetterTo_MemTsere(wNew, 4);
		wNew.finalizeWord();
	...
	public HebrewVerb future1S(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_AlefTsere(wNew, 4);
		wNew.finalizeWord();
	...
	public HebrewVerb future2MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_TavDageshTsere(wNew, 4);
		wNew.finalizeWord();
	...
	public HebrewVerb future3MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_YodTsere(wNew, 4);
		wNew.finalizeWord();
	...
	public HebrewVerb future1P(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_NunTsere(wNew, 4);
		wNew.finalizeWord();
	...
	public HebrewVerb future2FPB(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_TavDageshTsere(wNew, 2);
