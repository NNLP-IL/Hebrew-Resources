...
public class F25 extends F24{
	...
	public HebrewVerb present1MSB(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_MemTsere(wNew, 1);
		wNew.setVocalization_PATAH();
		wNew.movePointer(1);
		wNew.removeVocalization();
		wNew.finalizeWord();
	...
	public HebrewVerb present1FS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_MemShva(wNew, 2);
		wNew.setVocalization_DAGESH();
		this.macro_Kamats_Hey(wNew, 1);
		wNew.finalizeWord();
	...
	public HebrewVerb future1SB(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_AlefKamats(wNew, 1);
		wNew.setVocalization_PATAH();
		wNew.movePointer(1);
		wNew.removeVocalization();
		wNew.finalizeWord();
	...
	public HebrewVerb future3MSB(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_YodKamats(wNew, 1);
		wNew.setVocalization_PATAH();
		wNew.movePointer(1);
		wNew.removeVocalization();
		wNew.finalizeWord();
	...
	public HebrewVerb future1PB(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_NunKamats(wNew, 1);
		wNew.setVocalization_PATAH();
		wNew.movePointer(1);
		wNew.removeVocalization();
		wNew.finalizeWord();
