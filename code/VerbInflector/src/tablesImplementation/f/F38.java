...
public class F38 extends F1{
	...
	public HebrewLetter[] vocalize(HebrewLetter[] letterArr){
		...
		letterArr[3].setVocalization_HIRIK();
		if (letterArr[5].isKafSofit()){
			letterArr[5].setVocalization_SHVA();
		}
		return letterArr;
	}
	...
	public HebrewVerb present1MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_MemPatah(wNew, 5);
		wNew.finalizeWord();
	...
	public HebrewVerb future1S(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_AlefPatah(wNew, 5);
		wNew.finalizeWord();
	...
	public HebrewVerb future2MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_TavDageshPatah(wNew, 5);
		wNew.finalizeWord();
	...
	public HebrewVerb future3MS(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_YodPatah(wNew, 5);
		wNew.finalizeWord();
	...
	public HebrewVerb future1P(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_NunPatah(wNew, 5);
		wNew.finalizeWord();
	...
	public HebrewVerb future2FPB(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.replaceLetterTo_TavDageshPatah(wNew, 3);
