...
public class B14 extends B12{
	...
	public HebrewVerb future1SComp(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_AlefSegol(wNew, 0);
		this.macro_NunDageshKamats(wNew, 2);
		wNew.removeLetter();
	...
	public HebrewVerb future1SMiss(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_AlefHirik(wNew, 0);
		this.macro_NunDageshKamats(wNew, 2);
		wNew.removeLetter();
		wNew.setVocalization_TSERE();
		wNew.removeDagesh();
	...
	public HebrewVerb future2MSMiss(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_TavDageshHirik(wNew, 0);
		this.macro_NunDageshKamats(wNew, 2);
		wNew.removeLetter();
		wNew.setVocalization_TSERE();
		wNew.removeDagesh();
	...
	public HebrewVerb future3MSMiss(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_YodHirik(wNew, 0);
		this.macro_NunDageshKamats(wNew, 2);
		wNew.removeLetter();
		wNew.setVocalization_TSERE();
		wNew.removeDagesh();
	...
	public HebrewVerb future1PMiss(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_NunHirik(wNew, 0);
		this.macro_NunDageshKamats(wNew, 2);
		wNew.removeLetter();
		wNew.setVocalization_TSERE();
		wNew.removeDagesh();
	...
	public HebrewVerb imperative2MSMiss(HebrewVerb w){
		HebrewVerb wNew = new HebrewVerb(w);
		this.macro_BEFORE_HeyHirik(wNew, 0);
		this.macro_NunDageshKamats(wNew, 2);
		wNew.removeLetter();
		wNew.setVocalization_TSERE();
		wNew.removeDagesh();
